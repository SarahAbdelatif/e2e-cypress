describe("Text box with max characters" , () => {
    it('displays the appropriate remaining characters count', () => {
        ...
        cy.get('[data-cy="input-last-name"]').type('My  Freind');
    ...
    it('prevents the user from typing more characters once max was exceded' , () => {
        ...
        cy.get('[data-cy="input-last-name"]').type('hello world and my friends'); 

        cy.get('[data-cy="input-last-name"]').should('have.attr', 'value' , 'hello world and');
    });
});